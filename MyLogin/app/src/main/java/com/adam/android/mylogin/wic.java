...
public class wic extends AppCompatActivity {
    ...
    Button btnCheckin;
    String server_url_insert = "https://cgi.sice.indiana.edu/~afrankow/wic.php";
    String server_url_insert1 = "https://cgi.sice.indiana.edu/~afrankow/srscDescrip.php";
    String server_url_insert2 = "https://cgi.sice.indiana.edu/~afrankow/wicTracker.php";
    TextView tvresult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wic);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(wic.this, "e" + e.toString(), Toast.LENGTH_LONG).show();
                }
            }
        },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(wic.this, "err" + error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        );
        RequestQueue requestQueue = Volley.newRequestQueue(wic.this);
