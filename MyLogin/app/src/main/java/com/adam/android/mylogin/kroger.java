...
public class kroger extends AppCompatActivity {
    ...
    Button btnCheckin;
    String server_url_insert = "https://cgi.sice.indiana.edu/~afrankow/kroger.php";
    String server_url_insert1 = "https://cgi.sice.indiana.edu/~afrankow/srscDescrip.php";
    String server_url_insert2 = "https://cgi.sice.indiana.edu/~afrankow/krogertracker.php";
    TextView tvresult;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(kroger.this, "e" + e.toString(), Toast.LENGTH_LONG).show();
                }
            }
        },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(kroger.this, "err" + error.toString(), Toast.LENGTH_LONG).show();
                    }
                }
        );
        RequestQueue requestQueue = Volley.newRequestQueue(kroger.this);
